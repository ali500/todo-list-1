  ...
  <div class="mx-auto relative">
    ...
    <div class="mt-5 rounded bg-white text-zinc-800 shadow">
      <template v-for="todo in todolists" :key="`todo-${todo.id}`">
        <div
          class="py-5 px-5 flex first:border-t-0 border-t border-zinc-200 justify-between items-center group"
        >
          ...
          >
            <AppButton shape="circle" :color="AppColor.Indego">
              <svg
